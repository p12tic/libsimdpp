...
public:
    ...
    typedef float64<4,void> base_vector_type;
    typedef void expr_type;

#if SIMDPP_USE_AVX
    typedef __m256d native_type;
#endif

    SIMDPP_INL float64<4>() {}
...
public:
    ...
    typedef mask_float64<4,void> base_vector_type;
    typedef void expr_type;
