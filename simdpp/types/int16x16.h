...
*/
template<>
class int16<16> : public any_int16<16, int16<16>> {
public:
    ...
    template<unsigned N> SIMDPP_INL const int16<16>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL int16<16>& vec() { return *this; }
...
*/
template<>
class uint16<16> : public any_int16<16, uint16<16>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_UINT;
    using element_type = uint16_t;
    using base_vector_type = uint16<16>;
    using expr_type = void;
    ...
    template<unsigned N> SIMDPP_INL const uint16<16>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL uint16<16>& vec() { return *this; }
...
/// vector
template<>
class mask_int16<16> : public any_int16<16, mask_int16<16>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_MASK_INT;
    using base_vector_type = mask_int16<16>;
    using expr_type = void;
    ...
    SIMDPP_INL mask_int16<16>& operator=(const native_type& d) { d_ = d; return *this; }
    ...
    template<unsigned N> SIMDPP_INL const mask_int16<16>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL mask_int16<16>& vec() { return *this; }
