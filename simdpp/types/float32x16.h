...
public:
    ...
    {
        *this = bit_cast<float32<16>>(d.wrapped());
    }
    template<class V> SIMDPP_INL float32<16>& operator=(const any_vec<64,V>& d)
    {
        *this = bit_cast<float32<16>>(d.wrapped()); return *this;
    }
    ...
    template<unsigned N> const float32<16>& vec() const { return *this; }
    template<unsigned N> float32<16>& vec() { return *this; }
...
public:
    ...
    {
        *this = bit_cast<mask_float32<16>>(d); return *this;
    }
    ...
    template<unsigned N> const mask_float32<16>& vec() const { return *this; }
    template<unsigned N> mask_float32<16>& vec() { return *this; }
