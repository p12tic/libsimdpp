...
*/
template<>
class int32<8> : public any_int32<8, int32<8>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_INT;
    using element_type = int32_t;
    using base_vector_type = int32<8>;
    ...
    template<unsigned N> SIMDPP_INL const int32<8>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL int32<8>& vec() { return *this; }
...
*/
template<>
class uint32<8> : public any_int32<8, uint32<8>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_UINT;
    using element_type = uint32_t;
    using base_vector_type = uint32<8>;
    using expr_type = void;
    ...
    template<unsigned N> SIMDPP_INL const uint32<8>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL uint32<8>& vec() { return *this; }
...
/// vector
template<>
class mask_int32<8> : public any_int32<8, mask_int32<8>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_MASK_INT;
    using base_vector_type = mask_int32<8>;
    using expr_type = void;
    ...
    SIMDPP_INL mask_int32<8>& operator=(const native_type& d) { d_ = d; return *this; }

#if (SIMDPP_USE_AVX2 && !SIMDPP_USE_AVX512VL)
    SIMDPP_INL mask_int32<8>(const uint32<8>& d) : d_(d.native()) {}
#endif

    SIMDPP_INL explicit mask_int32<8>(const mask_float32<8>& d);
    SIMDPP_INL mask_int32<8>& operator=(const mask_float32<8>& d);
    ...
    template<unsigned N> SIMDPP_INL const mask_int32<8>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL mask_int32<8>& vec() { return *this; }
