...
public:
    ...
    template<unsigned N> SIMDPP_INL const int16<8>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL int16<8>& vec() { return *this; }
...
public:
    ...
    template<unsigned N> SIMDPP_INL const uint16<8>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL uint16<8>& vec() { return *this; }
...
public:
    ...
    template<unsigned N> SIMDPP_INL const mask_int16<8>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL mask_int16<8>& vec() { return *this; }
