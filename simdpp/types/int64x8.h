...
*/
template<>
class int64<8> : public any_int64<8, int64<8>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_INT;
    using element_type = int64_t;
    using base_vector_type = int64<8>;
    ...
    template<unsigned N> SIMDPP_INL const int64<8>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL int64<8>& vec() { return *this; }
...
*/
template<>
class uint64<8> : public any_int64<8, uint64<8>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_UINT;
    using element_type = uint64_t;
    using base_vector_type = uint64<8>;
    using expr_type = void;
    ...
    template<unsigned N> SIMDPP_INL const uint64<8>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL uint64<8>& vec() { return *this; }
...
/// vector
template<>
class mask_int64<8> : public any_int64<8, mask_int64<8>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_MASK_INT;
    using base_vector_type = mask_int64<8>;
    using expr_type = void;
    ...
    SIMDPP_INL mask_int64<8>& operator=(const native_type& d) { d_ = d; return *this; }

    SIMDPP_INL explicit mask_int64<8>(const mask_float64<8>& d);
    SIMDPP_INL mask_int64<8>& operator=(const mask_float64<8>& d);
    ...
    template<unsigned N> SIMDPP_INL const mask_int64<8>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL mask_int64<8>& vec() { return *this; }
