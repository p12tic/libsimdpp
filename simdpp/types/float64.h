...
*/
template<unsigned N>
class float64 : public any_float64<N, float64<N>> {
public:
    ...
    {
        *this = bit_cast<float64<N>>(d.wrapped());
    }
    template<class V> SIMDPP_INL float64<N>& operator=(const any_vec<N*8,V>& d)
    {
        *this = bit_cast<float64<N>>(d.wrapped()); return *this;
    }
    ...
    template<unsigned I> SIMDPP_INL const float64v& vec() const { return d_.template get<I>(); }
    template<unsigned I> SIMDPP_INL float64v& vec()             { return d_.template get<I>(); }
...
/// vector
template<unsigned N>
class mask_float64 : public any_float64<N, mask_float64<N>> {
public:
    ...
    SIMDPP_INL explicit mask_float64<N>(const mask_int64<N>& d)
    {
        *this = bit_cast<mask_float64<N>>(d);
    }
    SIMDPP_INL mask_float64<N>& operator=(const mask_int64<N>& d)
    {
        *this = bit_cast<mask_float64<N>>(d); return *this;
    }
    ...
    template<unsigned I> SIMDPP_INL const mask_float64v& vec() const { return d_.template get<I>(); }
    template<unsigned I> SIMDPP_INL mask_float64v& vec()             { return d_.template get<I>(); }
private:
