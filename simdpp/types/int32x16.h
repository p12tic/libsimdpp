...
*/
template<>
class int32<16> : public any_int32<16, int32<16>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_INT;
    using element_type = int32_t;
    using base_vector_type = int32<16>;
    ...
    template<unsigned N> SIMDPP_INL const int32<16>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL int32<16>& vec() { return *this; }
...
*/
template<>
class uint32<16> : public any_int32<16, uint32<16>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_UINT;
    using element_type = uint32_t;
    using base_vector_type = uint32<16>;
    using expr_type = void;
    ...
    template<unsigned N> SIMDPP_INL const uint32<16>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL uint32<16>& vec() { return *this; }
...
/// vector
template<>
class mask_int32<16> : public any_int32<16, mask_int32<16>> {
public:
    static const unsigned type_tag = SIMDPP_TAG_MASK_INT;
    using base_vector_type = mask_int32<16>;
    using expr_type = void;
    ...
    SIMDPP_INL mask_int32<16>& operator=(const native_type& d) { d_ = d; return *this; }

    SIMDPP_INL explicit mask_int32<16>(const mask_float32<16>& d);
    SIMDPP_INL mask_int32<16>& operator=(const mask_float32<16>& d);
    ...
    template<unsigned N> SIMDPP_INL const mask_int32<16>& vec() const { return *this; }
    template<unsigned N> SIMDPP_INL mask_int32<16>& vec() { return *this; }
