...
template<>
SIMDPP_INL int8x16 shift_r<0>(int8x16 a)      { return a; }
template<>
SIMDPP_INL uint8x16 shift_r<0>(uint8x16 a)    { return a; }
template<>
SIMDPP_INL int16x8 shift_r<0>(int16x8 a)      { return a; }
template<>
SIMDPP_INL uint16x8 shift_r<0>(uint16x8 a)    { return a; }
template<>
SIMDPP_INL int32x4 shift_r<0>(int32x4 a)      { return a; }
template<>
SIMDPP_INL uint32x4 shift_r<0>(uint32x4 a)    { return a; }
template<>
SIMDPP_INL int64x2 shift_r<0>(int64x2 a)      { return a; }
template<>
SIMDPP_INL uint64x2 shift_r<0>(uint64x2 a)    { return a; }
template<>
SIMDPP_INL uint8x16 shift_l<0>(uint8x16 a)  { return a; }
template<>
SIMDPP_INL uint16x8 shift_l<0>(uint16x8 a)  { return a; }
template<>
SIMDPP_INL uint32x4 shift_l<0>(uint32x4 a)  { return a; }
template<>
SIMDPP_INL uint64x2 shift_l<0>(uint64x2 a)  { return a; }
