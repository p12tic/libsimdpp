...
namespace simdpp {
    namespace SIMDPP_ARCH_NAMESPACE {
        ...
        */
        template<typename T>
        const std::pair<const size_t,const size_t> helper_input_range(const T* first, const T* last)
        {
            ...
            const T* ptr_aligned_first =(T*)detail::reach_next_aligned((void*)first, alignment);
