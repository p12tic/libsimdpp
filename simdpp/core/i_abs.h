...
uint8<N, expr_empty> abs(const int8<N,E>& a)
{
...
*/
template<unsigned N, class E> SIMDPP_INL
uint16<N, expr_empty> abs(const int16<N,E>& a)
{
    return detail::insn::i_iabs(a.eval());
}
...
*/
template<unsigned N, class E> SIMDPP_INL
uint32<N, expr_empty> abs(const int32<N,E>& a)
{
    return detail::insn::i_iabs(a.eval());
}
...
*/
template<unsigned N, class E> SIMDPP_INL
uint64<N, expr_empty> abs(const int64<N,E>& a)
{
    return detail::insn::i_iabs(a.eval());
}
