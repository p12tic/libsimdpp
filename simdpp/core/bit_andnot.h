...
{
    return bit_andnot(typename detail::get_expr_nomask<V, expr_scalar_bitwise<uint32_t>>::type{ { a }, 0 }, b);
}
template<unsigned N, class V> SIMDPP_INL
...
{
    return bit_andnot(typename detail::get_expr_nomask<V, expr_scalar_bitwise<uint64_t>>::type{ { a }, 0 }, b);
}
template<unsigned N, class V> SIMDPP_INL
...
{
    return bit_andnot(typename detail::get_expr_nomask<V, expr_scalar_bitwise<int32_t>>::type{ { a }, 0 }, b);
}
template<unsigned N, class V> SIMDPP_INL
...
{
    return bit_andnot(typename detail::get_expr_nomask<V, expr_scalar_bitwise<int64_t>>::type{ { a }, 0 }, b);
}
...
{
    return bit_andnot(a, typename detail::get_expr_nomask<V, expr_scalar_bitwise<uint32_t>>::type{ { b }, 0 });
}
template<unsigned N, class V> SIMDPP_INL
typename detail::get_expr_bitwise2_and<expr_bit_andnot, typename detail::get_expr_nomask<V, expr_scalar_bitwise<uint64_t>>::type, V>::type
        bit_andnot(const any_vec<N,V>& a, const uint64_t& b)
{
    return bit_andnot(a, typename detail::get_expr_nomask<V, expr_scalar_bitwise<uint64_t>>::type{ { b }, 0 });
}
template<unsigned N, class V> SIMDPP_INL
typename detail::get_expr_bitwise2_and<expr_bit_andnot, typename detail::get_expr_nomask<V, expr_scalar_bitwise<int32_t>>::type, V>::type
        bit_andnot(const any_vec<N,V>& a, const int32_t& b)
{
    return bit_andnot(a, typename detail::get_expr_nomask<V, expr_scalar_bitwise<int32_t>>::type{ { b }, 0 });
}
template<unsigned N, class V> SIMDPP_INL
typename detail::get_expr_bitwise2_and<expr_bit_andnot, typename detail::get_expr_nomask<V, expr_scalar_bitwise<int64_t>>::type, V>::type
        bit_andnot(const any_vec<N,V>& a, const int64_t& b)
{
    return bit_andnot(a, typename detail::get_expr_nomask<V, expr_scalar_bitwise<int64_t>>::type{ { b }, 0 });
}
