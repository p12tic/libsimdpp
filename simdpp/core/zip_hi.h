...
_PROMOTED_NOMASK_EXPRESSION_ zip16_hi(const any_vec8<N,V1>& a,
                                      const any_vec8<N,V2>& b);
template<unsigned N, class V1, class V2>
_PROMOTED_NOMASK_EXPRESSION_ zip8_hi(const any_vec16<N,V1>& a,
                                     const any_vec16<N,V2>& b);
template<unsigned N, class V1, class V2>
_PROMOTED_NOMASK_EXPRESSION_ zip4_hi(const any_vec32<N,V1>& a,
                                     const any_vec32<N,V2>& b);
template<unsigned N, class V1, class V2>
_PROMOTED_NOMASK_EXPRESSION_ zip2_hi(const any_vec64<N,V1>& a,
