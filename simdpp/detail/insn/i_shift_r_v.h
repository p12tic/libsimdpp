...
{
    typedef typename same_width<U8>::u16 U16;
...
{
    typedef typename same_width<I8>::i16 I16;
    typedef typename same_width<I8>::u16 U16;
...
{
    typedef typename same_width<U8>::u16 U16;
    typedef typename same_width<U8>::i16 I16;
...
{
    typedef typename same_width<U16>::u8 U8;
    typedef typename U16::mask_vector_type M16;
    // Variable shift is implemented by reusing shifter in 16-bit unsigned
