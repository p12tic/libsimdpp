...
SIMDPP_INL mask_float32x4 i_cmp_ge(float32x4 a, float32x4 b)
{
...
#if SIMDPP_USE_AVX
SIMDPP_INL mask_float32x8 i_cmp_ge(float32x8 a, float32x8 b)
{
...
SIMDPP_INL mask_float32<16> i_cmp_ge(float32<16> a, float32<16> b)
{
...
SIMDPP_INL mask_float64x2 i_cmp_ge(float64x2 a, float64x2 b)
{
...
#if SIMDPP_USE_AVX
SIMDPP_INL mask_float64x4 i_cmp_ge(float64x4 a, float64x4 b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL mask_float64<8> i_cmp_ge(float64<8> a, float64<8> b)
{
