...
void i_transpose2(uint8x16& a0, uint8x16& a1)
{
    ...
    uint8x16x2_t r = vtrnq_u8(a0.native(), a1.native());
    a0 = r.val[0];
    a1 = r.val[1];
...
#elif SIMDPP_USE_NEON
    uint16x8x2_t r = vtrnq_u16(a0.native(), a1.native());
    a0 = r.val[0];
    a1 = r.val[1];
#elif SIMDPP_USE_ALTIVEC || SIMDPP_USE_MSA
...
void i_transpose2(uint32x4& a0, uint32x4& a1)
{
    ...
    a1 = zip2_hi(b0, b1);
#elif SIMDPP_USE_NEON
    uint32x4x2_t r = vtrnq_u32(a0.native(), a1.native());
    a0 = r.val[0];
    a1 = r.val[1];
#elif SIMDPP_USE_ALTIVEC || SIMDPP_USE_MSA
...
#elif SIMDPP_USE_NEON
    float32x4x2_t r = vtrnq_f32(a0.native(), a1.native());
    a0 = r.val[0];
    a1 = r.val[1];
#elif SIMDPP_USE_ALTIVEC || SIMDPP_USE_MSA
    uint32x4 m0 = make_shuffle_bytes16_mask<0,4+0, 2,4+2>(m0);
