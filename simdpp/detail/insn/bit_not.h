...
SIMDPP_INL uint8x16 i_bit_not(uint8x16 a)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
SIMDPP_INL uint8x32 i_bit_not(uint8x32 a)
{
...
SIMDPP_INL uint32<4> i_bit_not(uint32<4> a)
{
    return uint32<4>(i_bit_not(uint8<16>(a)));
}

#if SIMDPP_USE_AVX2
SIMDPP_INL uint32<8> i_bit_not(uint32<8> a)
{
...
SIMDPP_INL uint32<16> i_bit_not(uint32<16> a)
{
...
SIMDPP_INL uint64<2> i_bit_not(uint64<2> a)
{
    return uint64<2>(i_bit_not(uint8<16>(a)));
}

#if SIMDPP_USE_AVX2
SIMDPP_INL uint64<4> i_bit_not(uint64<4> a)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL uint64<8> i_bit_not(uint64<8> a)
{
...
SIMDPP_INL mask_int8x16 i_bit_not(mask_int8x16 a)
{
#if SIMDPP_USE_NULL
...
SIMDPP_INL mask_int16x8 i_bit_not(mask_int16x8 a)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_not_mm(a);
#else
...
SIMDPP_INL mask_int32x4 i_bit_not(mask_int32x4 a)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_not_mm(a);
#else
...
SIMDPP_INL mask_int64x2 i_bit_not(mask_int64x2 a)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_not_mm(a);
#else
...
#if SIMDPP_USE_AVX2
SIMDPP_INL mask_int8x32  i_bit_not(mask_int8x32 a)  { return i_bit_not(uint8x32(a)); }
SIMDPP_INL mask_int16x16 i_bit_not(mask_int16x16 a) { return i_bit_not(uint16x16(a)); }
SIMDPP_INL mask_int32x8  i_bit_not(mask_int32x8 a)  { return i_bit_not(uint32x8(a)); }
SIMDPP_INL mask_int64x4  i_bit_not(mask_int64x4 a)  { return i_bit_not(uint64x4(a)); }
#endif

#if SIMDPP_USE_AVX512
SIMDPP_INL mask_int32<16> i_bit_not(mask_int32<16> a)
{
    return _mm512_knot(a);
}

SIMDPP_INL mask_int64<8> i_bit_not(mask_int64<8> a)
{
    return _mm512_knot(a);
}
#endif
...
template<unsigned N> SIMDPP_INL
mask_int8<N> i_bit_not(mask_int8<N> a)
{
    SIMDPP_VEC_ARRAY_IMPL1(mask_int8<N>, i_bit_not, a)
}
template<unsigned N> SIMDPP_INL
mask_int16<N> i_bit_not(mask_int16<N> a)
{
    SIMDPP_VEC_ARRAY_IMPL1(mask_int16<N>, i_bit_not, a)
}
template<unsigned N> SIMDPP_INL
mask_int32<N> i_bit_not(mask_int32<N> a)
{
    SIMDPP_VEC_ARRAY_IMPL1(mask_int32<N>, i_bit_not, a)
}
template<unsigned N> SIMDPP_INL
mask_int64<N> i_bit_not(mask_int64<N> a)
{
...
SIMDPP_INL float32x4 i_bit_not(float32x4 a)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX
SIMDPP_INL float32x8 i_bit_not(float32x8 a)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL float32<16> i_bit_not(float32<16> a)
{
    uint32<16> ones = uint32<16>::ones();
    return bit_xor(a, ones);
}
...
SIMDPP_INL float64x2 i_bit_not(float64x2 a)
{
...
#if SIMDPP_USE_AVX
SIMDPP_INL float64x4 i_bit_not(float64x4 a)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL float64<8> i_bit_not(float64<8> a)
{
    uint64<8> ones = uint64<8>::ones();
    return bit_xor(a, ones);
}
...
SIMDPP_INL mask_float32x4 i_bit_not(mask_float32x4 a)
{
...
#if SIMDPP_USE_AVX
SIMDPP_INL mask_float32x8 i_bit_not(mask_float32x8 a)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL mask_float32<16> i_bit_not(mask_float32<16> a)
{
    return _mm512_knot(a);
}
#endif
...
SIMDPP_INL mask_float64x2 i_bit_not(mask_float64x2 a)
{
#if SIMDPP_USE_NULL || SIMDPP_USE_NEON || SIMDPP_USE_ALTIVEC
    return detail::null::bit_not_mm(a);
#else
...
#if SIMDPP_USE_AVX
SIMDPP_INL mask_float64x4 i_bit_not(mask_float64x4 a)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL mask_float64<8> i_bit_not(mask_float64<8> a)
{
    return _mm512_knot(a);
}
#endif
