...
SIMDPP_INL uint8x16 i_zip16_hi(uint8x16 a, uint8x16 b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
SIMDPP_INL uint8x32 i_zip16_hi(uint8x32 a, uint8x32 b)
{
...
SIMDPP_INL uint16x8 i_zip8_hi(uint16x8 a, uint16x8 b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
SIMDPP_INL uint16x16 i_zip8_hi(uint16x16 a, uint16x16 b)
{
...
SIMDPP_INL uint32x4 i_zip4_hi(uint32x4 a, uint32x4 b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
SIMDPP_INL uint32x8 i_zip4_hi(uint32x8 a, uint32x8 b)
{
...
SIMDPP_INL uint32<16> i_zip4_hi(uint32<16> a, uint32<16> b)
{
...
SIMDPP_INL uint64x2 i_zip2_hi(uint64x2 a, uint64x2 b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
SIMDPP_INL uint64x4 i_zip2_hi(uint64x4 a, uint64x4 b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL uint64<8> i_zip2_hi(uint64<8> a, uint64<8> b)
{
...
SIMDPP_INL float32x4 i_zip4_hi(float32x4 a, float32x4 b)
{
...
#if SIMDPP_USE_AVX
SIMDPP_INL float32x8 i_zip4_hi(float32x8 a, float32x8 b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL float32<16> i_zip4_hi(float32<16> a, float32<16> b)
{
...
SIMDPP_INL float64x2 i_zip2_hi(float64x2 a, float64x2 b)
{
...
#if SIMDPP_USE_AVX
SIMDPP_INL float64x4 i_zip2_hi(float64x4 a, float64x4 b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL float64<8> i_zip2_hi(float64<8> a, float64<8> b)
{
