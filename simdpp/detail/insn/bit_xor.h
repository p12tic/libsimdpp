...
// -----------------------------------------------------------------------------
// uint8, uint8
SIMDPP_INL uint8x16 i_bit_xor(uint8x16 a, uint8x16 b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
SIMDPP_INL uint8x32 i_bit_xor(uint8x32 a, uint8x32 b)
{
...
uint8<N> i_bit_xor(uint8<N> a, uint8<N> b)
{
...
// -----------------------------------------------------------------------------
// mask_int8, mask_int8
SIMDPP_INL mask_int8x16 i_bit_xor(mask_int8x16 a, mask_int8x16 b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
SIMDPP_INL mask_int8x32 i_bit_xor(mask_int8x32 a, mask_int8x32 b)
{
    return _mm256_xor_si256(a, b);
    }
#endif
...
// -----------------------------------------------------------------------------
// uint16, uint16
SIMDPP_INL uint16<8> i_bit_xor(uint16<8> a, uint16<8> b)
{
    return (uint16<8>) i_bit_xor(uint8<16>(a), uint8<16>(b));
}

#if SIMDPP_USE_AVX2
SIMDPP_INL uint16<16> i_bit_xor(uint16<16> a, uint16<16> b)
{
    return _mm256_xor_si256(a, b);
}
#endif
...
SIMDPP_INL mask_int16<8> i_bit_xor(mask_int16<8> a, mask_int16<8> b)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_xor_mm(a, b);
#else
...
#if SIMDPP_USE_AVX2
SIMDPP_INL mask_int16<16> i_bit_xor(mask_int16<16> a, mask_int16<16> b)
{
...
// -----------------------------------------------------------------------------
// uint32, uint32
SIMDPP_INL uint32<4> i_bit_xor(uint32<4> a, uint32<4> b)
{
    return (uint32<4>) i_bit_xor(uint8<16>(a), uint8<16>(b));
}

#if SIMDPP_USE_AVX2
SIMDPP_INL uint32<8> i_bit_xor(uint32<8> a, uint32<8> b)
{
    return _mm256_xor_si256(a, b);
}
#endif
...
SIMDPP_INL uint32<16> i_bit_xor(uint32<16> a, uint32<16> b)
{
...
SIMDPP_INL mask_int32<4> i_bit_xor(mask_int32<4> a, mask_int32<4> b)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_xor_mm(a, b);
#else
...
#if SIMDPP_USE_AVX2
SIMDPP_INL mask_int32<8> i_bit_xor(mask_int32<8> a, mask_int32<8> b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL mask_int32<16> i_bit_xor(mask_int32<16> a, mask_int32<16> b)
{
...
// -----------------------------------------------------------------------------
// uint64, uint64
SIMDPP_INL uint64<2> i_bit_xor(uint64<2> a, uint64<2> b)
{
    return (uint64<2>) i_bit_xor(uint8<16>(a), uint8<16>(b));
}

#if SIMDPP_USE_AVX2
SIMDPP_INL uint64<4> i_bit_xor(uint64<4> a, uint64<4> b)
{
    return _mm256_xor_si256(a, b);
}
#endif
...
#if SIMDPP_USE_AVX512
SIMDPP_INL uint64<8> i_bit_xor(uint64<8> a, uint64<8> b)
{
...
SIMDPP_INL mask_int64<2> i_bit_xor(mask_int64<2> a, mask_int64<2> b)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_xor_mm(a, b);
#else
...
#if SIMDPP_USE_AVX2
SIMDPP_INL mask_int64<4> i_bit_xor(mask_int64<4> a, mask_int64<4> b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL mask_int64<8> i_bit_xor(mask_int64<8> a, mask_int64<8> b)
{
    return _mm512_kxor(a, b);
}
#endif
...
SIMDPP_INL float32x4 i_bit_xor(float32x4 a, float32x4 b)
{
...
#if SIMDPP_USE_AVX
SIMDPP_INL float32x8 i_bit_xor(float32x8 a, float32x8 b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL float32<16> i_bit_xor(float32<16> a, float32<16> b)
{
...
SIMDPP_INL mask_float32x4 i_bit_xor(mask_float32x4 a, mask_float32x4 b)
{
#if SIMDPP_USE_NULL || SIMDPP_USE_NEON_NO_FLT_SP
    return detail::null::bit_xor_mm(a, b);
#else
...
#if SIMDPP_USE_AVX
SIMDPP_INL mask_float32x8 i_bit_xor(mask_float32x8 a, mask_float32x8 b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL mask_float32<16> i_bit_xor(mask_float32<16> a, mask_float32<16> b)
{
    return _mm512_kxor(a, b);
}
#endif
...
SIMDPP_INL float64x2 i_bit_xor(float64x2 a, float64x2 b)
{
...
#if SIMDPP_USE_AVX
SIMDPP_INL float64x4 i_bit_xor(float64x4 a, float64x4 b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL float64<8> i_bit_xor(float64<8> a, float64<8> b)
{
...
SIMDPP_INL mask_float64x2 i_bit_xor(mask_float64x2 a, mask_float64x2 b)
{
#if SIMDPP_USE_NULL || SIMDPP_USE_NEON || SIMDPP_USE_ALTIVEC
    return detail::null::bit_xor_mm(a, b);
#else
...
#if SIMDPP_USE_AVX
SIMDPP_INL mask_float64x4 i_bit_xor(mask_float64x4 a, mask_float64x4 b)
{
...
#if SIMDPP_USE_AVX512
SIMDPP_INL mask_float64<8> i_bit_xor(mask_float64<8> a, mask_float64<8> b)
{
    return _mm512_kxor(a, b);
}
#endif
