...
#if SIMDPP_USE_AVX2
inline void i_split(uint8<32> a, uint8<16>& r1, uint8<16>& r2)
{
...
#if SIMDPP_USE_AVX2
inline void i_split(uint16<16> a, uint16<8>& r1, uint16<8>& r2)
{
    r1 = _mm256_castsi256_si128(a);
    r2 = _mm256_extracti128_si256(a, 1);
}
...
#if SIMDPP_USE_AVX2
inline void i_split(uint32<8> a, uint32<4>& r1, uint32<4>& r2)
{
    r1 = _mm256_castsi256_si128(a);
    r2 = _mm256_extracti128_si256(a, 1);
}
...
inline void i_split(uint32<16> a, uint32<8>& r1, uint32<8>& r2)
{
...
#if SIMDPP_USE_AVX2
inline void i_split(uint64<4> a, uint64<2>& r1, uint64<2>& r2)
{
    r1 = _mm256_castsi256_si128(a);
    r2 = _mm256_extracti128_si256(a, 1);
}
...
#if SIMDPP_USE_AVX512
inline void i_split(uint64<8> a, uint64<4>& r1, uint64<4>& r2)
{
    // r1 = _mm512_castsi512_si256(a); GCC BUG
    r1 = _mm512_extracti64x4_epi64(a, 0);
    r2 = _mm512_extracti64x4_epi64(a, 1);
...
#if SIMDPP_USE_AVX
inline void i_split(float32<8> a, float32<4>& r1, float32<4>& r2)
{
...
#if SIMDPP_USE_AVX512
inline void i_split(float32<16> a, float32<8>& r1, float32<8>& r2)
{
...
#if SIMDPP_USE_AVX
inline void i_split(float64<4> a, float64<2>& r1, float64<2>& r2)
{
...
#if SIMDPP_USE_AVX512
inline void i_split(float64<8> a, float64<4>& r1, float64<4>& r2)
{
