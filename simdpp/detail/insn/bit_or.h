...
uint8<N> i_bit_or(const uint8<N>& a, const uint8<N>& b)
{
...
template<unsigned N> SIMDPP_INL
mask_int8<N> i_bit_or(const mask_int8<N>& a, const mask_int8<N>& b)
{
...
template<unsigned N> SIMDPP_INL
uint16<N> i_bit_or(const uint16<N>& a, const uint16<N>& b)
{
...
template<unsigned N> SIMDPP_INL
mask_int16<N> i_bit_or(const mask_int16<N>& a, const mask_int16<N>& b)
{
...
template<unsigned N> SIMDPP_INL
uint32<N> i_bit_or(const uint32<N>& a, const uint32<N>& b)
{
...
template<unsigned N> SIMDPP_INL
mask_int32<N> i_bit_or(const mask_int32<N>& a, const mask_int32<N>& b)
{
...
template<unsigned N> SIMDPP_INL
uint64<N> i_bit_or(const uint64<N>& a, const uint64<N>& b)
{
...
template<unsigned N> SIMDPP_INL
mask_int64<N> i_bit_or(const mask_int64<N>& a, const mask_int64<N>& b)
{
...
template<unsigned N> SIMDPP_INL
float32<N> i_bit_or(const float32<N>& a, const float32<N>& b)
{
...
template<unsigned N> SIMDPP_INL
mask_float32<N> i_bit_or(const mask_float32<N>& a, const mask_float32<N>& b)
{
...
template<unsigned N> SIMDPP_INL
float64<N> i_bit_or(const float64<N>& a, const float64<N>& b)
{
...
template<unsigned N> SIMDPP_INL
mask_float64<N> i_bit_or(const mask_float64<N>& a, const mask_float64<N>& b)
{
