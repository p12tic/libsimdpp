...
inline float32x4 i_to_float32(int32x4 a)
{
#if SIMDPP_USE_NULL
...
inline float32<16> i_to_float32(int32<16> a)
{
...
inline float32x4 i_to_float32(float64x4 a)
{
...
#if SIMDPP_USE_AVX
inline float32x8 i_to_float32(float64<8> a)
{
#if SIMDPP_USE_AVX512
