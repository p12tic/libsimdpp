...
uint8<16> expr_eval_sub(const uint8<16,E1>& qa,
...
#if SIMDPP_USE_AVX2
template<class R, class E1, class E2> SIMDPP_INL
uint8<32> expr_eval_sub(const uint8<32,E1>& qa,
...
template<class R, class E1, class E2> SIMDPP_INL
uint8<64> expr_eval_sub(const uint8<64,E1>& qa,
...
template<class R, class E1, class E2> SIMDPP_INL
uint16<8> expr_eval_sub(const uint16<8,E1>& qa,
...
#if SIMDPP_USE_AVX2
template<class R, class E1, class E2> SIMDPP_INL
uint16<16> expr_eval_sub(const uint16<16,E1>& qa,
...
#if SIMDPP_USE_AVX512BW
template<class R, class E1, class E2> SIMDPP_INL
uint16<32> expr_eval_sub(const uint16<32,E1>& qa,
...
template<class R, class E1, class E2> SIMDPP_INL
uint32<4> expr_eval_sub(const uint32<4,E1>& qa,
...
#if SIMDPP_USE_AVX2
template<class R, class E1, class E2> SIMDPP_INL
uint32<8> expr_eval_sub(const uint32<8,E1>& qa,
...
template<class R, class E1, class E2> SIMDPP_INL
uint32<16> expr_eval_sub(const uint32<16,E1>& qa,
...
template<class R, class E1, class E2> SIMDPP_INL
uint64<2> expr_eval_sub(const uint64<2,E1>& qa,
...
#if SIMDPP_USE_AVX2
template<class R, class E1, class E2> SIMDPP_INL
uint64<4> expr_eval_sub(const uint64<4,E1>& qa,
...
#if SIMDPP_USE_AVX512F
template<class R, class E1, class E2> SIMDPP_INL
uint64<8> expr_eval_sub(const uint64<8,E1>& qa,
