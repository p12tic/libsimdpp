...
float32<4> expr_eval(expr_sub<float32<4,E1>,
                              float32<4,E2>> q)
{
...
#if SIMDPP_USE_AVX
template<class E1, class E2>
float32<8> expr_eval(expr_sub<float32<8,E1>,
                              float32<8,E2>> q)
{
...
template<class E1, class E2>
float32<16> expr_eval(expr_sub<float32<16,E1>,
                               float32<16,E2>> q)
{
...
float32<N> expr_eval(expr_sub<float32<N,E1>,
                              float32<N,E2>> q)
{
...
template<class E1, class E2>
float64<2> expr_eval(expr_sub<float64<2,E1>,
                              float64<2,E2>> q)
{
...
#if SIMDPP_USE_AVX
template<class E1, class E2>
float64<4> expr_eval(expr_sub<float64<4,E1>,
                              float64<4,E2>> q)
{
...
#if SIMDPP_USE_AVX512
template<class E1, class E2>
float64<8> expr_eval(expr_sub<float64<8,E1>,
                              float64<8,E2>> q)
{
...
template<unsigned N, class E1, class E2>
float64<N> expr_eval(expr_sub<float64<N,E1>,
                              float64<N,E2>> q)
{
