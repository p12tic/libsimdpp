...
float32<4> expr_eval_sub(const float32<4,E1>& qa,
...
#if SIMDPP_USE_AVX
template<class R, class E1, class E2> SIMDPP_INL
float32<8> expr_eval_sub(const float32<8,E1>& qa,
...
template<class R, class E1, class E2> SIMDPP_INL
float32<16> expr_eval_sub(const float32<16,E1>& qa,
...
float32<N> expr_eval_sub(const float32<N,E1>& qa,
...
template<class R, class E1, class E2> SIMDPP_INL
float64<2> expr_eval_sub(const float64<2,E1>& qa,
...
#if SIMDPP_USE_AVX
template<class R, class E1, class E2> SIMDPP_INL
float64<4> expr_eval_sub(const float64<4,E1>& qa,
...
#if SIMDPP_USE_AVX512F
template<class R, class E1, class E2> SIMDPP_INL
float64<8> expr_eval_sub(const float64<8,E1>& qa,
...
template<class R, unsigned N, class E1, class E2> SIMDPP_INL
float64<N> expr_eval_sub(const float64<N,E1>& qa,
