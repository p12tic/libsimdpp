...
int8<N, _DETAIL_> shift_l_DISABLED(int8<N,E> a);

template<unsigned count, unsigned N, class E>
uint8<N, _DETAIL_> shift_l_DISABLED(uint8<N,E> a);
#else
template<unsigned count, unsigned N, class E>
int8<N, int8<N>> shift_l_DISABLED(int8<N,E> a)
{
...
template<unsigned count, unsigned N, class E>
uint8<N, uint8<N>> shift_l_DISABLED(uint8<N,E> a)
{
    static_assert(count <= 8, "Shift out of bounds");
    if (count == 0) return a;
...
#if SIMDPP_DOXYGEN
template<unsigned count, unsigned N, class E>
int16<N, _DETAIL_> shift_l_DISABLED(int16<N,E> a);

template<unsigned count, unsigned N, class E>
uint16<N, _DETAIL_> shift_l_DISABLED(uint16<N,E> a);
#else
template<unsigned count, unsigned N, class E>
int16<N, int16<N>> shift_l_DISABLED(int16<N,E> a)
{
...
template<unsigned count, unsigned N, class E>
uint16<N, uint16<N>> shift_l_DISABLED(uint16<N,E> a)
{
    static_assert(count <= 16, "Shift out of bounds");
    if (count == 0) return a;
...
#if SIMDPP_DOXYGEN
template<unsigned count, unsigned N, class E>
int32<N, _DETAIL_> shift_l_DISABLED(int32<N,E> a);

template<unsigned count, unsigned N, class E>
uint32<N, _DETAIL_> shift_l_DISABLED(uint32<N,E> a);
#else
template<unsigned count, unsigned N, class E>
int32<N, int32<N>> shift_l_DISABLED(int32<N,E> a)
{
...
template<unsigned count, unsigned N, class E>
uint32<N, uint32<N>> shift_l_DISABLED(uint32<N,E> a)
{
    static_assert(count <= 32, "Shift out of bounds");
    if (count == 0) return a;
...
#if SIMDPP_DOXYGEN
template<unsigned count, unsigned N, class E>
int64<N, _DETAIL_> shift_l_DISABLED(int64<N,E> a);

template<unsigned count, unsigned N, class E>
uint64<N, _DETAIL_> shift_l_DISABLED(uint64<N,E> a);
#else
template<unsigned count, unsigned N, class E>
int64<N, int64<N>> shift_l_DISABLED(int64<N,E> a)
{
...
template<unsigned count, unsigned N, class E>
uint64<N, uint64<N>> shift_l_DISABLED(uint64<N,E> a)
{
    static_assert(count <= 64, "Shift out of bounds");
    if (count == 0) return a;
