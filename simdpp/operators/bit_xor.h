...
{
    return operator^(detail::make_const<typename detail::get_expr_nomask<V>::type>(a), b);
}
...
{
    return operator^(a, detail::make_const<typename detail::get_expr_nomask<V>::type>(b));
}
