...
template<unsigned N>
struct GetElementType<simdpp::uint8<N>> { static const ElementType value = TYPE_UINT8; };
template<unsigned N>
struct GetElementType<simdpp::int8<N>> { static const ElementType value = TYPE_INT8; };
template<unsigned N>
struct GetElementType<simdpp::uint16<N>> { static const ElementType value = TYPE_UINT16; };
template<unsigned N>
struct GetElementType<simdpp::int16<N>> { static const ElementType value = TYPE_INT16; };
template<unsigned N>
struct GetElementType<simdpp::uint32<N>> { static const ElementType value = TYPE_UINT32; };
template<unsigned N>
struct GetElementType<simdpp::int32<N>> { static const ElementType value = TYPE_INT32; };
template<unsigned N>
struct GetElementType<simdpp::float32<N>> { static const ElementType value = TYPE_FLOAT32; };
template<unsigned N>
struct GetElementType<simdpp::uint64<N>> { static const ElementType value = TYPE_UINT64; };
template<unsigned N>
struct GetElementType<simdpp::int64<N>> { static const ElementType value = TYPE_INT64; };
template<unsigned N>
struct GetElementType<simdpp::float64<N>> { static const ElementType value = TYPE_FLOAT64; };
