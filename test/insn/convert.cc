...
void test_convert_int8_n(TestResultsSet& ts)
{
    ...
    typedef uint32<B> uint32_4n;
    typedef int32<B> int32_4n;
    typedef uint64<B> uint64_8n;
    typedef int64<B> int64_8n;
    typedef float32<B> float32_4n;
    typedef float64<B> float64_8n;
